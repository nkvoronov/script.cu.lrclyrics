...
FLAC stream found is used. For 'naked' FLACs, see mutagen_culrc.flac.
...
from mutagen_culrc.flac import StreamInfo, VCFLACDict, StrictFileObject
from mutagen_culrc.ogg import OggPage, OggFileType, error as OggError
